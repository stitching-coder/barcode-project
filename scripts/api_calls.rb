...
#   j = {id: i, tcs: []}
  ...
  url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/85/top_containers"
  # url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/3/tree/root"
  response = req.authenticated_http_get_request(url)
  puts JSON.parse(response.body).to_json
  # url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/3828/top_containers"
  # response = req.authenticated_http_get_request(url)
  # puts JSON.parse(response.body)
  # url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/2361/top_containers"
  # response = req.authenticated_http_get_request(url)
  # puts JSON.parse(response.body)
  # url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/3/top_containers"
  # response = req.authenticated_http_get_request(url)
  # puts JSON.parse(response.body)
  # j[:tcs] = JSON.parse(response.body)
#   puts j.inspect
# end
...
# puts req.authenticated_http_get_request(url).body

# # Get a CSV template useful for bulk-creating containers for archival objects of a resource
# # Saves the csv to file 'resource_1_top_container_creation.csv'
# url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/85/templates/top_container_creation.csv"
# puts req.authenticated_http_get_request(url).body

# # Get a CSV template useful for bulk-creating containers for archival objects of a resource
# # Saves the csv to file 'resource_1_top_container_creation.csv'
# url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/3828/templates/top_container_creation.csv"
# puts req.authenticated_http_get_request(url).body

# # Get a CSV template useful for bulk-creating containers for archival objects of a resource
# # Saves the csv to file 'resource_1_top_container_creation.csv'
# url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/2361/templates/top_container_creation.csv"
# puts req.authenticated_http_get_request(url).body

# # Get a CSV template useful for bulk-creating containers for archival objects of a resource
# # Saves the csv to file 'resource_1_top_container_creation.csv'
# url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/resources/3/templates/top_container_creation.csv"
# puts req.authenticated_http_get_request(url).body
...
# url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/location_profiles?all_ids=true"
...
# url = "https://uclalsc-staff.lyrasistechnology.org/api/repositories/2/locations?page=1"
# response = unauthenticated_http_get_request(url)
